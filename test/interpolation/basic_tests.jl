...
@testset "Test Float32" begin
    ...
    for itp in (itp1, itp2)
        ...
        @inferred itp(0.5, 0.5; method=Farin(1))
        ...
        @inferred itp(0.5, 0.5; method=Farin(1), project=false)
        ...
        @inferred itp(0.5f0, 0.5f0; method=Farin(1))
        ...
        @inferred itp(0.5f0, 0.5f0; method=Farin(1), project=false)
        ...
        @inferred itp(0.5f0, 0.5; method=Farin(1))
        ...
        @inferred itp(0.5f0, 0.5; method=Farin(1), project=false)
        ...
        @inferred itp(0.5, 0.5f0; method=Farin(1))
        ...
        @inferred itp(0.5, 0.5f0; method=Farin(1), project=false)
    end
    ...
    @test itp1(0.5f0, 0.5f0; method=Farin(1)) ≈ itp2(0.5f0, 0.5f0; method=Farin(1))
    @test itp1(0.5f0, 0.5f0; method=Sibson(), project=false) ≈ itp2(0.5f0, 0.5f0; method=Sibson(), project=false)
    @test itp1(0.5f0, 0.5f0; method=Sibson(1), project=false) ≈ itp2(0.5f0, 0.5f0; method=Sibson(1), project=false)
    ...
    @test itp1(0.5f0, 0.5f0; method=Farin(1), project=false) ≈ itp2(0.5f0, 0.5f0; method=Farin(1), project=false)
